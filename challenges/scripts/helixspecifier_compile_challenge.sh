#!/usr/bin/env bash
# helixspecifier_compile_challenge.sh - Validates HelixSpecifier module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.helixspecifier"
if grep -q "^module digital.vasic.helixspecifier$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.helixspecifier"
else
